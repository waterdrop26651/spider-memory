...
export function isNodeVersionAtLeast(version, minimumVersion) {
...
export function isCurrentNodeVersionSupportedByLatestPi() {
    return isNodeVersionAtLeast(process.versions.node, MINIMUM_NODE_VERSION_FOR_LATEST_PI);
}
export function getLatestPiNodeRequirementMessage(updateCommand) {
