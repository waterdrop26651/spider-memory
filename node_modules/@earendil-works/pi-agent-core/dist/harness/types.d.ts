...
export declare class FileError extends Error {
    ...
    /** Absolute addressed path associated with the failure, when available. */
    path?: string | undefined, cause?: Error);
}
...
export declare class ExecutionError extends Error {
    ...
    constructor(
    /** Backend-independent error code. */
    code: ExecutionErrorCode, message: string, cause?: Error);
}
...
export declare class CompactionError extends Error {
    ...
    constructor(
    /** Backend-independent error code. */
    code: CompactionErrorCode, message: string, cause?: Error);
}
...
export declare class BranchSummaryError extends Error {
    ...
    constructor(
    /** Backend-independent error code. */
    code: BranchSummaryErrorCode, message: string, cause?: Error);
}
...
export declare class SessionError extends Error {
    ...
    constructor(
    /** Session subsystem error code. */
    code: SessionErrorCode, message: string, cause?: Error);
}
